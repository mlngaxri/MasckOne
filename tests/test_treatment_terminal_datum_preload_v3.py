...
def test_v3_builds_all_four_moment_balanced_terminal_stations():
...
def test_v3_preserves_rigid_working_load_path_and_physical_firewall():
    manifest = build_terminal_datum_preload_v3_architecture().manifest()
