...
@pytest.mark.parametrize("field,value", [
    ("usable_capacity_mL", 34.9),
    ("contractual_required_usable_capacity_mL", 26.9),
    ("conservative_required_usable_capacity_mL", 30.1),
    ("first_conservative_capacity_failure_cycle", 6),
    ("minimum_overflow_at_failure_mL", .1),
    ("conservative_overflow_at_failure_mL", .1),
    ("contractual_reserve_headroom_mL", 7.9),
...
def test_guard_rejects_lookalike_routing_evidence():
    ...
    with pytest.raises(WasteFluidAccountingError):
        CartridgeOverflowGuard(
            routing=object(),
            capacity_reserve_mL=guard.capacity_reserve_mL,
            usable_capacity_mL=guard.usable_capacity_mL,
            contractual_required_usable_capacity_mL=guard.contractual_required_usable_capacity_mL,
            conservative_required_usable_capacity_mL=guard.conservative_required_usable_capacity_mL,
            first_unavoidable_overflow_cycle=guard.first_unavoidable_overflow_cycle,
            first_conservative_capacity_failure_cycle=guard.first_conservative_capacity_failure_cycle,
            minimum_overflow_at_failure_mL=guard.minimum_overflow_at_failure_mL,
            conservative_overflow_at_failure_mL=guard.conservative_overflow_at_failure_mL,
            contractual_reserve_headroom_mL=guard.contractual_reserve_headroom_mL,
            conservative_reserve_headroom_mL=guard.conservative_reserve_headroom_mL,
        )
