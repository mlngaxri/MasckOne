...
**CAD evidence status:** the repository does not currently contain a concise reviewer-ready gallery of released-main computer-aided design (CAD) screenshots. The three product views below are therefore labelled as registered candidate digital compositions, not released CAD. The controlled model source, engineering authority and automated checks linked below are the stronger engineering record.
