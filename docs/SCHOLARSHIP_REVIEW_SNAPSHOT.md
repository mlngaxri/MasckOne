...
[Project overview](../README.md) · [Venture progress](VENTURE_PROGRESS.md) · [Customer discovery](CUSTOMER_DISCOVERY.md) · [Next-stage evidence plan](SCHOLARSHIP_NEXT_STAGE.md)
...
This is the short reviewer path. It separates what has been built from what still needs customer, physical and commercial evidence.
