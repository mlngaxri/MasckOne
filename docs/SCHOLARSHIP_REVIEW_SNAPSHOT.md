...
Engineering-source links below are pinned to audited engineering revision `8d37bc322b5ebe42179685a1a0559f2fcb1b5f22`, which is live `main` at this review. Pinning prevents later branch movement from silently changing the evidence behind these claims. Scholarship documentation may advance independently and must not be read as a newer engineering release.
