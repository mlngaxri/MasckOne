...
| What has been built? | Inspectable requirements, engineering geometry, code-based CAD, automated checks, subsystem records and whole-product integration work exist in the repository. | This demonstrates active digital development, not customer demand, physical performance, comfort, safety, manufacturability or product readiness. |
