# Masck One: 60-second reviewer path

This page is an entry point for a non-technical scholarship reviewer. It points to evidence already in this repository and does not add product-performance claims.

## 1. What is the venture?

Masck One is an early-stage, pre-commercialisation venture exploring whether selected repetitive parts of a facial-skincare routine can be automated while creating net convenience after setup, cleaning and maintenance are counted.

The current target-user hypothesis is people who already follow multi-step facial-skincare routines and value reducing active time and repetitive handling. That segment is not yet validated.

## 2. What is the first product?

It has not been earned yet. The long-term wearable-and-dock concept is a direction to investigate, not a committed first-product specification.
...
3. A focused physical fit and workflow prototype.
4. Repeatable core fluid-delivery testing, including failed runs.
5. Hygiene, cleaning and servicing investigation.
6. Initial manufacturing-cost modelling from sourced assumptions.
...
Live engineering `main` is `8d37bc322b5ebe42179685a1a0559f2fcb1b5f22`, committed 16 September 2026. Scholarship-review documentation after that baseline must not be read as a newer engineering release.

For the canonical evidence-bounded overview, see [Scholarship review snapshot](SCHOLARSHIP_REVIEW_SNAPSHOT.md). For the concise one-page venture view, see [One-page venture proof](SCHOLARSHIP_ONE_PAGE_VENTURE_PROOF.md).
