...
def test_rejects_missing_or_unexpected_member_radius() -> None:
    radii = _radii()
...
def test_rejects_nonfinite_type_confused_or_nonpositive_radii() -> None:
...
def test_rejects_malformed_or_degenerate_datums() -> None:
    ...
    degenerate = RetentionDatums(
        left_yoke=(-74.0, 18.0, -42.0),
        right_yoke=(82.0, 8.0, 4.0),
        left_junction=(-74.0, 18.0, -42.0),
        right_junction=(74.0, 18.0, -42.0),
        crown_apex=(0.0, 104.0, -28.0),
    ...
    with pytest.raises(ValueError, match="degenerate load path"):
        build_retention_cad(degenerate, _radii())
