...
def _sources() -> tuple[SourceBinding, ...]:
    return (
        ...
        SourceBinding("RETENTION_V2", "CANDIDATE_PR", "src/masck_one/retention_load_path.py", "RetentionLoadPathPackage", "9647405b36642105c929a3fdd0617d03bfe68c98", "bec4c294f400c86f15acca863341f09b34d96b28", 92, "Cell 3 retention lineage is reconstructed on the same post-PR121 base anchor; retained load-path B-rep blob is unchanged and crown/front-frame counterparts remain open."),
