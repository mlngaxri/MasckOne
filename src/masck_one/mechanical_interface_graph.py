...
def _sources() -> tuple[SourceBinding, ...]:
    return (
        ...
        SourceBinding("RETENTION_V2", "CANDIDATE_PR", "src/masck_one/retention_load_path.py", "RetentionLoadPathPackage", "9647405b36642105c929a3fdd0617d03bfe68c98", "88a88bed01fd3b3acfb38ff5f6f3ae3d5bbf54fe", 92, "Cell 3 retention lineage is reconstructed on the same post-PR121 current-main base; retained load-path B-rep blob is unchanged and crown/front-frame counterparts remain open."),
