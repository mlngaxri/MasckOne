...
RECONCILED_MAIN_SHA = "d02bce5b5cb43e33febd6e1a40fdc98f3893efca"
...
# a controlled 90 degree rotation about +X. The tab is kept inside the cradle-side
# package corridor so the current 2.0 mm water-package reservation remains intact.
RETENTION_TAB_CENTER_X_MM = 15.25
RETENTION_TAB_X_MM = 0.40
