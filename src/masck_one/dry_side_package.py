...
PCB_SHELF_BRIDGE_MM = (20.0, 2.0, SUPPORT_RIB_THICKNESS_MM)
PCB_SHELF_BRIDGE_CENTER_MM = (0.0, 31.0, -30.9)
BATTERY_GUIDE_BRIDGE_MM = (3.0, SUPPORT_RIB_THICKNESS_MM, 8.0)
BATTERY_GUIDE_BRIDGE_X_MM = 21.5
BATTERY_GUIDE_BRIDGE_CENTER_YZ_MM = (0.0, -39.0)
...
def _build_geometry(authority):
    ...
    shelf_bridge=_box(PCB_SHELF_BRIDGE_MM,PCB_SHELF_BRIDGE_CENTER_MM)
    guide_bridge_left=_box(BATTERY_GUIDE_BRIDGE_MM,(-BATTERY_GUIDE_BRIDGE_X_MM,BATTERY_GUIDE_BRIDGE_CENTER_YZ_MM[0],BATTERY_GUIDE_BRIDGE_CENTER_YZ_MM[1]))
    guide_bridge_right=_box(BATTERY_GUIDE_BRIDGE_MM,(BATTERY_GUIDE_BRIDGE_X_MM,BATTERY_GUIDE_BRIDGE_CENTER_YZ_MM[0],BATTERY_GUIDE_BRIDGE_CENTER_YZ_MM[1]))
    structure=shell.union(support).union(shelf_bridge).union(guide_left).union(guide_bridge_left).union(guide_right).union(guide_bridge_right)
...
def build_dry_side_package(authority=None,model=None):
    ...
    physical=(PackageGeometry("DRY_BAY_CARRIER_STRUCTURE","internal dry-side carrier shell, positively bridged PCB shelf and battery guide structure",structure,"PHYSICAL_MATERIAL_CANDIDATE","DRY_ALWAYS","DIGITAL_BREP_CANDIDATE"),)
