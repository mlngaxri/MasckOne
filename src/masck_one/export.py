...
def export_release(output_dir: str | Path = "generated", model: MasckOneModel | None = None) -> dict:
    ...
    report = {
        ...
        "quantitative_ledgers": {
            "mass_cg_power_fluid_v1": quantitative_manifest,
        },
        "analysis_frameworks": {
        ...
        "exported_quantitative_files": ["quantitative_ledger_v1.json"],
        "note": (
            ...
            "serviceability. The Cell 18 quantitative ledger credits only the authority battery packaging benchmark and "
            "four explicitly labelled H2W sibling-model actuator mass benchmarks; full dry/loaded mass, whole-product CG, "
            "pitch, load power, runtime and fluid loaded masses remain unresolved. Digital topology/manifests, ledgers and "
