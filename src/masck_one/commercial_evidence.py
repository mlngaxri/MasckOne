...
class EvidenceRecord:
    ...
    def validate_invariants(self) -> None:
        ...
        if self.evidence_class in {EvidenceClass.PUBLIC_MARKET_BENCHMARK, EvidenceClass.PUBLIC_SUPPLIER_CAPABILITY}:
        ...
        if self.evidence_class in {EvidenceClass.PRODUCT_MEASUREMENT, EvidenceClass.SUPPLIER_QUALIFICATION} and self.status is not EvidenceStatus.CONTROLLED:
...
class CommercialBurden:
    ...
    def validate_invariants(self) -> None:
        ...
        try:
            ...
            raise ValueError("burden value must be finite and non-negative") from exc
...
def _public_supplier(evidence_id: str, observed: date, url: str, statement: str) -> EvidenceRecord:
    return EvidenceRecord(evidence_id, EvidenceClass.PUBLIC_SUPPLIER_CAPABILITY, EvidenceStatus.REFERENCE_ONLY, observed, url, statement)


def build_cell4_reference_registry() -> CommercialEvidenceRegistry:
    observed = date(2026, 9, 1)
    evidence = (
        EvidenceRecord("MKT_APPLE_BATTERY_SERVICE_2026_09_01", EvidenceClass.PUBLIC_MARKET_BENCHMARK, EvidenceStatus.REFERENCE_ONLY, observed, "https://www.apple.com/au/batteries/service-and-recycling/", "Apple publicly describes rechargeable-battery ageing and service pathways; this is a service benchmark, not Masck One runtime evidence."),
        EvidenceRecord("MKT_DYSON_AU_SERVICE_2026_09_01", EvidenceClass.PUBLIC_MARKET_BENCHMARK, EvidenceStatus.REFERENCE_ONLY, observed, "https://www.dyson.com.au/dyson-stores-and-service-centres", "Dyson Australia publicly exposes repair and service-centre pathways; this is a support benchmark only."),
        EvidenceRecord("MKT_EIGHTSLEEP_WARRANTY_2026_09_01", EvidenceClass.PUBLIC_MARKET_BENCHMARK, EvidenceStatus.REFERENCE_ONLY, observed, "https://www.eightsleep.com/warranty/", "Eight Sleep publicly couples some warranty coverage to active membership; this is an ownership-burden reference only."),
        _public_supplier("SUP_PLANET_INNOVATION_2026_09_01", observed, "https://planetinnovation.com/manufacturing/", "Planet Innovation publicly describes NPI, contract manufacturing, consumables, leak testing and ISO 13485-compliant manufacturing systems."),
        _public_supplier("SUP_CIRCUITWISE_2026_09_01", observed, "https://circuitwise.com.au/", "Circuitwise publicly describes PCBA, DFM, inspection, integration and functional-test capabilities under ISO 13485 and related systems."),
        _public_supplier("SUP_REID_PRINT_2026_09_01", observed, "https://reidprinttechnologies.com.au/", "Reid Print Technologies publicly describes flexible printed sensors, membrane interfaces, wearable electronics and ISO 13485/ISO 9001 systems."),
        _public_supplier("SUP_TRELLEBORG_MEDICAL_2026_09_01", observed, "https://www.trelleborg.com/en/medical", "Trelleborg Medical Solutions publicly describes silicone, plastic injection molding, DFM and prototype-to-serial capabilities."),
        _public_supplier("SUP_PHILLIPS_MEDISIZE_MOLDING_2026_09_01", observed, "https://phillipsmedisize.com/capabilities/manufacturing/advanced-injection-molding/", "Phillips Medisize publicly describes plastic injection molding, liquid silicone rubber molding, tooling and electromechanical integration capabilities."),
        _public_supplier("SUP_JABIL_HEALTHCARE_2026_09_01", observed, "https://www.jabil.com/industries/healthcare.html", "Jabil publicly describes healthcare design/manufacturing capabilities and site-specific quality systems; exact Masck One fit remains unqualified."),
        _public_supplier("SUP_TESSY_2026_09_01", observed, "https://tessy.com/", "Tessy publicly describes precision plastics, tooling, assembly, prototyping and global manufacturing capabilities."),
    )
    burdens = tuple(CommercialBurden(kind=kind, status=BurdenStatus.UNRESOLVED) for kind in BurdenKind)
    suppliers = (
        SupplierRecord("PLANET_INNOVATION", "Planet Innovation", SupplierState.REFERENCE_CANDIDATE, ("integrated NPI", "alpha-to-pilot manufacturing", "assembly/test architecture"), ("SUP_PLANET_INNOVATION_2026_09_01",)),
        SupplierRecord("TRELLEBORG_MEDICAL", "Trelleborg Medical Solutions", SupplierState.REFERENCE_CANDIDATE, ("compliant-interface molding", "rigid plastic molding", "DFM/prototype process development"), ("SUP_TRELLEBORG_MEDICAL_2026_09_01",)),
        SupplierRecord("CIRCUITWISE", "Circuitwise", SupplierState.REFERENCE_CANDIDATE, ("PCBA NPI", "electronics inspection", "functional-test integration"), ("SUP_CIRCUITWISE_2026_09_01",)),
        SupplierRecord("REID_PRINT_TECHNOLOGIES", "Reid Print Technologies", SupplierState.REFERENCE_CANDIDATE, ("sealed HMI prototypes", "flexible sensor coupons", "heater/sensing coupons"), ("SUP_REID_PRINT_2026_09_01",)),
        SupplierRecord("PHILLIPS_MEDISIZE", "Phillips Medisize", SupplierState.REFERENCE_CANDIDATE, ("integrated NPI comparator", "LSR/plastic molding", "electromechanical assembly"), ("SUP_PHILLIPS_MEDISIZE_MOLDING_2026_09_01",)),
        SupplierRecord("JABIL_HEALTHCARE", "Jabil Healthcare", SupplierState.REFERENCE_CANDIDATE, ("scale manufacturing", "electronics/plastics integration", "lifecycle manufacturing"), ("SUP_JABIL_HEALTHCARE_2026_09_01",)),
        SupplierRecord("TESSY_PLASTICS", "Tessy Plastics", SupplierState.REFERENCE_CANDIDATE, ("precision plastics", "tooling", "complex assembly"), ("SUP_TESSY_2026_09_01",)),
    )
    return CommercialEvidenceRegistry("CELL4_COMMERCIAL_EVIDENCE_V1_2026_09_01", evidence, burdens, suppliers)
