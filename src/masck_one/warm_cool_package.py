...
class WarmCoolPackage:
    ...
    def manifest(self) -> dict[str, object]:
        return {
            ...
            "current_off_face_hardware_candidate": "masck_one.thermal_reset_hardware",
            "current_thermal_model": "masck_one.thermal_reset_physics",
            "hardware_selection_scope": "PASSIVE_CHOKED_PLATE_STORE_BENCH_COMPARISON; PRODUCT_COOL_NOT_FROZEN",
